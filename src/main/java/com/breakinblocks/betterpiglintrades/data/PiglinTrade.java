 ...
 */
public record PiglinTrade(Item item, Optional<ResourceLocation> lootTable, int priority, boolean enabled) {
    ...
    public static final Codec<PiglinTrade> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            ResourceLocation.CODEC.optionalFieldOf("loot_table").forGetter(PiglinTrade::lootTable),
